...
class RoiPdfGenerator(private val context: Context) {
    ...
    fun generateAndSharePdf(state: RoiState) {
        ...
        fun drawHeader() {
            ...
            canvas.drawText("ROI Calculation", MARGIN, 60f, paint) // CHANGED TITLE

            paint.textSize = 14f
            paint.typeface = Typeface.DEFAULT
            val subText = "Generated by Navyuga" // CHANGED FOOTER TEXT
        ...
        // Net Annual Income - BOLD SEPARATE LINE
        y += 10f
        checkSpace(30f)
        paint.color = BRAND_BLUE
        paint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD)
        ...
        canvas.drawRect(MARGIN, y, rightEdge, y + 80f, boxPaint)
        ...
        val resultTitle = if (state.isBuyerMode) "PROJECTED ROI" else "TARGET ROI"
        canvas.drawText(resultTitle, (PAGE_WIDTH / 2).toFloat(), y + 30f, paint)
